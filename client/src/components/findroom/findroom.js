  ...
  return (
    <div class="fixed z-10 inset-0 overflow-y-auto">
      <div class="flex flex-col items-end justify-center align-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="flex-shrink-0 flex items-center justify-center h-full w-full rounded-full bg-white sm:mx-0 sm:h-10 sm:w-10">
          <svg
        ...
        <div className="flex flex-col w-full h-full items-center justify-center">
          {state.length > 0 ? (
            state.map((item, i) => <Card key={i} item={item} />)
          ) : (
            <div
